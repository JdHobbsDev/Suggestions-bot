    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('suggestion-id')
                .setDescription('The 6-digit ID of the suggestion to accept')
                .setRequired(true))
        .addStringOption(option =>
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = EmbedBuilder.from(message.embeds[0])
                .setColor(0x2ecc71)
                .spliceFields(0, 1, { name: '📊 Status', value: '`Accepted ✅`', inline: true })
                .addFields({
                    name: `✅ Accept Reason (by ${interaction.user.tag})`,
                    value: `>>> ${reason}`
                });
            ...
            try {
                ...
                const dmEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`Your suggestion has been accepted by a moderator.`)
                    .addFields(
            ...
            await interaction.reply({
                content: `Suggestion ${suggestionId} has been accepted.`,
                flags: 64
            });
        } catch (error) {
            console.error('Error in /accept-suggestion command:', error);
            await interaction.reply({
                content: 'There was an error accepting the suggestion. Please try again later.',
                flags: 64
            });
        }
    }
